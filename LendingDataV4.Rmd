...
features <- c("loan_status", "grade", "sub_grade", "open_acc","pub_rec", "dti", "delinq_2yrs", "inq_last_6mths", "emp_length", "annual_inc", "home_ownership",  "purpose", "addr_state", "loan_amnt","int_rate", "installment", "issue_d", "revol_bal", "revol_util")
LD <- subset(LD, select = features)
LD <- LD[!apply(LD == "", 1, all),]
LD$purpose <- LD$purpose[which(LD$purpose == "medical")]
```
